...
const emojiMap = {
  ...
  '🎟': '<i className="fa-solid fa-ticket"></i>', // without variation selector
  ...
  '🗑': '<i className="fa-solid fa-trash"></i>', // without variation selector
  ...
  '🛡️': '<i className="fa-solid fa-shield"></i>',
  '🛡': '<i className="fa-solid fa-shield"></i>',
  '🛑': '<i className="fa-solid fa-stop"></i>',
  '🚗': '<i className="fa-solid fa-car"></i>',
  '🏍️': '<i className="fa-solid fa-motorcycle"></i>',
  '🏷️': '<i className="fa-solid fa-tag"></i>',
  '⬇️': '<i className="fa-solid fa-arrow-down"></i>',
